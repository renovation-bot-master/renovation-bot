...
async def generate_pdf(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        logger.info(f"Услуги: {list(selected_services.keys())}")
        ...
        logger.info(f"Сметы создана: {estimate_data['total']}")
        ...
        logger.info("Собираю PDF...")
        doc.build(story)
        pdf_buffer.seek(0)
        
        logger.info("Отправляю PDF в Телеграм...")
        ...
        logger.info("PDF отправлена успешно!")
